                    ...
                    <div class="col-lg-12">
                        <div class="ibox ">
                            <div class="ibox-content">
                                <form method="post" action="{{route('edit.store.page',$page->id)}}" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-10">
                                            <textarea class="form-control summernote" name="short_content" rows="10">{{$page->short_content}}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-10">
                                            <textarea class="form-control summernote" name="content" rows="10">{{$page->content}}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-10">
                                            <input type="file" class="form-control dropify" name="banner" data-default-file="{{url('uploads/banner/'.$page->banner)}}">
                                        </div>
                                    </div>
