        ...
        <div id="page-wrapper" class="gray-bg">
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                ...
                <div class="col-lg-6 text-right">
                    <a class="btn btn-sm btn-primary mt-4" href="{{route('add.page')}}"><i class="fa fa-plus"></i> Add New</a>
                </div>
            </div>
                                ...
                                <table class="table table-striped table-bordered table-hover dataTables-example" >
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="gradeX">
                                            <td>{{$i++}}</td>
                                            <td>{{$pageRow->title}}</td>
                                            <td><img src="{{url('uploads/banner/'.$pageRow->banner)}}" width="50px;"></td>
                                            <td>
                                                <a class="btn btn-xs btn-primary" href="{{route('edit.page',$pageRow->id)}}"><i class="fa fa-edit"></i></a>
                                                <a class="btn btn-xs btn-danger" href="{{route('delete.page',$pageRow->id)}}" onclick="return confirm('Sure! You want to delete this item!')"><i class="fa fa-trash"></i></a>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
