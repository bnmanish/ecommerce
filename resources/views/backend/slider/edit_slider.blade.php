                    ...
                    <div class="col-lg-12">
                        <div class="ibox ">
                            <div class="ibox-content">
                                <form method="post" action="{{route('edit.store.slider',$slider->id)}}" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-10">
                                            <input type="number" class="form-control" name="sequence" value="{{$slider->sequence}}">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-10">
                                            <input type="text" class="form-control" name="text1" value="{{$slider->text1}}">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-10">
                                            <input type="text" class="form-control" name="text2" value="{{$slider->text2}}">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-10">
                                            <input type="file" class="form-control dropify" data-default-file="{{url('uploads/slider/'.$slider->image)}}" name="image">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-10 row">
                                            <div class="col-lg-2">
                                                <div class="i-checks">
                                                    <label>
                                                        <input type="radio" value="1" name="status" @php if($slider->status == 1){echo "checked";} @endphp> <i></i> Enabled
                                                    </label>
                                                </div>
                                            </div>
                                            <div class="col-lg-2">
                                                <div class="i-checks">
                                                    <label>
                                                        <input type="radio" value="0" name="status" @php if($slider->status == 0){echo "checked";} @endphp> <i></i> Disable
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
