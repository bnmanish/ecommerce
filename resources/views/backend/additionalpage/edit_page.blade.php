...
<head>
    ...
    <title>Edit Additional Pages</title>
                    ...
                    <div class="col-lg-12">
                        <div class="ibox ">
                            <div class="ibox-content">
                                <form method="post" action="{{route('edit.store.additional.page',$page->id)}}" enctype="multipart/form-data">
                                    @csrf
                                    <div class="form-group row">
                                        <label class="col-lg-2 col-form-label">Page Title</label>
                                        <div class="col-lg-10">
                                            <input type="text" class="form-control title" name="page_title" value="{{$page->page_title}}">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="text" class="form-control url" name="url" value="{{$page->url}}">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-10">
                                            <textarea class="form-control summernote" name="page_content" rows="10">{{$page->page_content}}</textarea>
                                        </div>
                                    </div>
                                    {{--
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-10">
                                            <input type="file" class="form-control dropify" name="banner" data-default-file="{{url('uploads/page/'.$page->banner)}}">
                                        </div>
                                    </div>
                                    --}}
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-10">
                                            <select data-placeholder="Choose a Postion..." class="chosen-select form-control"  tabindex="2" name="position">
                                                ...
                                                <option value="0" @php if($page->position == 0){echo "selected";} @endphp>Header</option>
                                                <option value="1" @php if($page->position == 1){echo "selected";} @endphp>Footer</option>
                                                <option value="2" @php if($page->position == 2){echo "selected";} @endphp>Both</option>
                                            </select>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-10 row">
                                            <div class="col-lg-2">
                                                <div class="i-checks">
                                                    <label>
                                                        <input type="radio" value="1" name="status" @php if($page->status == 1){echo "checked";} @endphp> <i></i> Enabled
                                                    </label>
                                                </div>
                                            </div>
                                            <div class="col-lg-2">
                                                <div class="i-checks">
                                                    <label>
                                                        <input type="radio" value="0" name="status" @php if($page->status == 0){echo "checked";} @endphp> <i></i> Disable
                                                    </label>
                                                </div>
                                            </div>
