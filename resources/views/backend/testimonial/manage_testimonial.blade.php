        ...
        <div id="page-wrapper" class="gray-bg">
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                ...
                <div class="col-lg-6 text-right">
                    <a class="btn btn-sm btn-primary mt-4" href="{{route('add.testimonial')}}"><i class="fa fa-plus"></i> Add New</a>
                </div>
            </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover dataTables-example" >
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="gradeX">
                                            <td>{{$i++}}</td>
                                            <td>{{$testimonialRow->title}}</td>
                                            <td>{{$testimonialRow->name}}</td>
                                            <td>{{$testimonialRow->position}}</td>
                                            <td>{{$testimonialRow->description}}</td>
                                            <td>
                                                <a class="btn btn-xs btn-danger" href="{{route('delete.testimonial',$testimonialRow->id)}}" onclick="return confirm('Sure! You want to delete this item!')"><i class="fa fa-trash"></i></a>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
