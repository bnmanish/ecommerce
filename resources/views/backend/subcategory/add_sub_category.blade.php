...
<body>
                            ...
                            <div class="ibox-content">
                                <form method="post" action="{{route('store.sub.category')}}" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-10">
                                            <input type="text" class="form-control cat" name="subcategory" value="{{old('subcategory')}}">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-10">
                                            <textarea class="form-control summernote" name="description" rows="10">{{old('description')}}</textarea>
                                        </div>
                                    </div>
    ...
    <!-- SUMMERNOTE -->
    <!-- Select2 -->
    <script src="{{url('backend/js/plugins/select2/select2.full.min.js')}}"></script>
    <!-- Select2 -->
    <script>
