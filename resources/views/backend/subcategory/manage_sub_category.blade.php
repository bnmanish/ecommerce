        ...
        <div id="page-wrapper" class="gray-bg">
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                ...
                <div class="col-lg-6 text-right">
                    <a class="btn btn-sm btn-primary mt-4" href="{{route('add.sub.category')}}"><i class="fa fa-plus"></i> Add New</a>
                </div>
            </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover dataTables-example" >
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="gradeX">
                                            <td>{{$i++}}</td>
                                            <td>{{$subcatRow->sub_category}}</td>
                                            <td><img src="{{url('uploads/subcategory/'.$subcatRow->image)}}" width="50px;"></td>
                                            <td><input id="{{$subcatRow->id}}" class="form-control sequence" type="text" name="sequence" style="width: 100px;" value="{{$subcatRow->sequence}}"></td>
                                            <td>
                                            ...
                                            <td>
                                                <a class="btn btn-xs btn-primary" href="{{route('edit.sub.category',$subcatRow->id)}}"><i class="fa fa-edit"></i></a>
                                                <a class="btn btn-xs btn-danger" href="{{route('delete.sub.category',$subcatRow->id)}}" onclick="return confirm('Sure! You want to delete this item!')"><i class="fa fa-trash"></i></a>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
    ...
    <script>
        $(document).ready(function(){
            ...
            $('.sequence').keyup(function(){
                ...
                $.ajax({
                    url : "{{route('sub.category.sequence')}}",
                    type : "get",
                    data : {seq:seq,id:id},
