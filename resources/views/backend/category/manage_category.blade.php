        ...
        <div id="page-wrapper" class="gray-bg">
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                ...
                <div class="col-lg-6 text-right">
                    <a class="btn btn-sm btn-primary mt-4" href="{{route('add.category')}}"><i class="fa fa-plus"></i> Add New</a>
                </div>
            </div>
                                ...
                                <table class="table table-striped table-bordered table-hover dataTables-example" >
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="gradeX">
                                            ...
                                            <td><img src="{{url('uploads/category/'.$catRow->image)}}" width="50px;"></td>
                                            <td><input id="{{$catRow->id}}" class="form-control sequence" type="text" name="sequence" style="width: 100px;" value="{{$catRow->sequence}}"></td>
                                            <td>
                                                @if($catRow->status == 1)
                                                    Enable
                                                @else
                                            ...
                                            <td>
                                                <a class="btn btn-xs btn-primary" href="{{route('edit.category',$catRow->id)}}"><i class="fa fa-edit"></i></a>
                                                <a class="btn btn-xs btn-danger" href="{{route('delete.category',$catRow->id)}}" onclick="return confirm('Sure! You want to delete this item!')"><i class="fa fa-trash"></i></a>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
