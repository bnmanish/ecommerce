        ...
        <div id="page-wrapper" class="gray-bg">
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                ...
                <div class="col-lg-6 text-right">
                    <a class="btn btn-sm btn-primary mt-4" href="{{route('add.social.media')}}"><i class="fa fa-plus"></i> Add New</a>
                </div>
            </div>
                                ...
                                <table class="table table-striped table-bordered table-hover dataTables-example" >
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="gradeX">
                                            ...
                                            <td>{{$dataRow->title}}</td>
                                            <td>{{$dataRow->link}}</td>
                                            <td><img src="{{url('uploads/social/'.$dataRow->icon)}}" width="50px;"></td>
                                            <td>
                                                @if($dataRow->status == 1)
                                                    Enable
                                                @else
                                            ...
                                            <td>
                                                <a class="btn btn-xs btn-primary" href="{{route('edit.social.media',$dataRow->id)}}"><i class="fa fa-edit"></i></a>
                                                <a class="btn btn-xs btn-danger" href="{{route('delete.social.media',$dataRow->id)}}" onclick="return confirm('Sure! You want to delete this item!')"><i class="fa fa-trash"></i></a>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
