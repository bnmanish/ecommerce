											...
											<a class="dropdown-item" href="javascript:;">
												<div class="d-flex align-items-center">
													...
													<div class="position-relative">
														...
														<div class="cart-product">
															<img src="{{url('frontend/images/products/05.png')}}" class="" alt="product image">
														</div>
													</div>
												</div>
											</a>
											<a class="dropdown-item" href="javascript:;">
												<div class="d-flex align-items-center">
													...
													<div class="position-relative">
														...
														<div class="cart-product">
															<img src="{{url('frontend/images/products/17.png')}}" class="" alt="product image">
														</div>
													</div>
												</div>
											</a>
											<a class="dropdown-item" href="javascript:;">
												<div class="d-flex align-items-center">
													...
													<div class="position-relative">
														...
														<div class="cart-product">
															<img src="{{url('frontend/images/products/10.png')}}" class="" alt="product image">
														</div>
													</div>
												</div>
											</a>
											<a class="dropdown-item" href="javascript:;">
												<div class="d-flex align-items-center">
													...
													<div class="position-relative">
														...
														<div class="cart-product">
															<img src="{{url('frontend/images/products/08.png')}}" class="" alt="product image">
														</div>
													</div>
												</div>
											</a>
											<a class="dropdown-item" href="javascript:;">
												<div class="d-flex align-items-center">
													...
													<div class="position-relative">
														...
														<div class="cart-product">
															<img src="{{url('frontend/images/products/18.png')}}" class="" alt="product image">
														</div>
													</div>
												</div>
											</a>
											<a class="dropdown-item" href="javascript:;">
												<div class="d-flex align-items-center">
													...
													<div class="position-relative">
														...
														<div class="cart-product">
															<img src="{{url('frontend/images/products/04.png')}}" class="" alt="product image">
														</div>
													</div>
												</div>
											</a>
											<a class="dropdown-item" href="javascript:;">
												<div class="d-flex align-items-center">
													...
													<div class="position-relative">
														...
														<div class="cart-product">
															<img src="{{url('frontend/images/products/16.png')}}" class="" alt="product image">
														</div>
													</div>
												</div>
											</a>
							...
							<div class="row">
								...
								<div class="col-md-4">
									<div class="pramotion-banner1">
										<img src="{{url('frontend/images/gallery/menu-img.jpg')}}" class="img-fluid" alt="" />
									</div>
								</div>
								<!-- end col-3 -->
							</div>
