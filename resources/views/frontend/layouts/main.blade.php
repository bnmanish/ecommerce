            ...
            <div class="minicart__product">
                <div class="minicart__product--items d-flex">
                    <div class="minicart__thumbnail">
                        <a href="product-details.html"><img src="{{url('assets/frontend/img/product/product1.webp')}}" alt="prduct-img"></a>
                    </div>
                ...
                <div class="minicart__product--items d-flex">
                    <div class="minicart__thumbnail">
                        <a href="product-details.html"><img src="{{url('assets/frontend/img/product/product2.webp')}}" alt="prduct-img"></a>
                    </div>
                    <div class="minicart__text">
    ...
    <footer class="footer__section footer__bg">
        <div class="container-fluid">
            ...
            <div class="footer__bottom d-flex justify-content-between align-items-center">
                <p class="copyright__content  m-0">Copyright © 2022 <a class="copyright__content--link" href="{{route('home')}}">Furea</a> . All Rights Reserved.Design By Furea</p>
