                ...
                <div class="col-lg-6">
                    <div class="about__thumbnail d-flex">
                        <div class="about__thumbnail--items">
                            <img class="about__thumbnail--img border-radius-5 display-block" src="{{url('assets/frontend/img/other/about-thumb-list1.webp')}}" alt="about-thumbnail">
                        </div>
                        <div class="about__thumbnail--items position__relative">
                            <img class="about__thumbnail--img border-radius-5 display-block" src="{{url('assets/frontend/img/other/about-thumb-list2.webp')}}" alt="about-thumbnail">
                ...
                <div class="col-lg-6">
                    <div class="about__content">
                        ...
                        <div class="about__author position__relative">
                            ...
                            <img class="about__author--signature" src="{{url('assets/frontend/img/icon/signature.webp')}}" alt="signature">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="team__container">
                <div class="row">
                    <div class="col-lg-3 col-md-4 col-sm-6 col-6 custom-col">
                        <div class="team__items text-center">
                            <div class="team__thumbnail">
                                <img class="team__thumbnail--img border-radius-50 display-block" src="{{url('assets/frontend/img/other/team1.webp')}}" alt="team-thumb">
                            </div>
                            <div class="team__content ">
                                ...
                                <ul class="team__social d-flex justify-content-center align-items-center">
                                    <li class="team__social--list">
                                        <a class="team__social--icon" target="_blank" href="../../../../external.html?link=https://www.facebook.com/">
                                    ...
                                    <li class="team__social--list">
                                        <a class="team__social--icon" target="_blank" href="../../../../external.html?link=https://twitter.com/">
                                    ...
                                    <li class="team__social--list">
                                        <a class="team__social--icon" target="_blank" href="../../../../external.html?link=https://www.skype.com/">
                                    ...
                                    <li class="team__social--list">
                                        <a class="team__social--icon" target="_blank" href="../../../../external.html?link=https://www.youtube.com/">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-6 custom-col">
                        <div class="team__items text-center">
                            <div class="team__thumbnail">
                                <img class="team__thumbnail--img border-radius-50 display-block" src="{{url('assets/frontend/img/other/team2.webp')}}" alt="team-thumb">
                            </div>
                            <div class="team__content">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-6 custom-col">
                        <div class="team__items text-center">
                            <div class="team__thumbnail">
                                <img class="team__thumbnail--img border-radius-50 display-block" src="{{url('assets/frontend/img/other/team3.webp')}}" alt="team-thumb">
                            </div>
                            <div class="team__content">
